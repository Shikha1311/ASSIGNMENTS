...
<body>
 <form action="r2" method="post" >
     <fieldset style="width:1000px">  
      ...
      <form:errors path="R.username" cssClass="error"/><br><br>
      </p>
      <p>
      Please Enter Your Password :  <input type="password" name="password"/> 
      <form:errors path="R.password" cssClass="error"/><br><br>   
      </p>
      <p>
      Please Enter Your Email : <input type="email" name="email"/>
      <form:errors path="R.email" cssClass="error"/><br><br>
      </p>
      <p>
      Please Enter Your Contact No. : <input type="text" name="contact"/>
                  <form:errors path="R.contact" cssClass="error"/><br><br>
      </p>
      <p>
      Please Enter Your City : <select name="city">
         ...
         <option value="Shahdol">Shahdol</option>
            ...
            <form:errors path="R.city" cssClass="error"/><br><br>
      </p>
      <p>
      Please Enter Your Pin : <input type="text" name="pin"/>  
      <form:errors path="R.pin" cssClass="error"/><br><br>   
      </p>  
